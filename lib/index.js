...
async function createCodebase(deps, metaPath, spec) {
	...
	const probeResult = await deps.sshRunner([
		"-o",
		"BatchMode=yes",
		"-o",
		"ConnectTimeout=5",
	...
	const installResult = await deps.sshRunner([
		spec.host,
		"uv",
		"tool",
		"install",
	...
	const startResult = await deps.sshRunner([
		spec.host,
		"vectr",
		"start",
		spec.path,
	...
	const tunnelResult = await deps.sshRunner([
		"-f",
		"-N",
		"-L",
