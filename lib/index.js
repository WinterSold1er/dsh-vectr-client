...
const TUNNEL_PORT_MIN = (process.env.VECTR_TUNNEL_PORT_MIN ? parseInt(process.env.VECTR_TUNNEL_PORT_MIN, 10) : void 0) || 8760;
const TUNNEL_PORT_MAX = (process.env.VECTR_TUNNEL_PORT_MAX ? parseInt(process.env.VECTR_TUNNEL_PORT_MAX, 10) : void 0) || 8799;
