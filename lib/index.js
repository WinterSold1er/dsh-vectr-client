...
const VECTR_GUIDANCE_SECTION_TEXT = "When answering code-query or codebase-navigation questions, prefer the vectr MCP tools (mcp__vectr__*) over blind file reads. Use them to search, retrieve, and reason over the indexed workspace.";
/**
...
//#endregion
export { Config, DEFAULT_CODEBASES_FILE, DEFAULT_DAEMON_HTTP_TIMEOUT_MS, DEFAULT_DAEMON_TCP_TIMEOUT_MS, DEFAULT_INSTANCES_FILE, DEFAULT_SECRETS_FILE, DEFAULT_SERVER_NAME, DEFAULT_TOOL_CALL_TIMEOUT_MS, DEFAULT_TUNNEL_PROBE_MS, STARTUP_HEAL_COOLDOWN_MS, VECTR_GUIDANCE_SECTION_NAME, VECTR_GUIDANCE_SECTION_ORDER, VECTR_GUIDANCE_SECTION_TEXT, apply, buildCodebaseDeps, ensureTunnelUp, inject, install, installCodebaseConnections, isDaemonAlive, isPortListening, name, probeTunnel, readInstancesFile, registerCodebaseRoutes, registerManagementRoutes, resolveInstance, slugFromPathname, startupHealEligible };
