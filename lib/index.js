...
function formatMode(mode, live) {
	...
	if (mode === "full" || mode === "memory_only" || mode === "search_only" || mode === "lite") return mode;
	return "unknown";
}
//#endregion
