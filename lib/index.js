...
async function healTunnelOnce(deps, metaPath, entry) {
	if ((await probeTunnel(entry, deps)).alive) return {
		entry,
		healed: false
	};
	let auth;
	...
	if (localPort === void 0 || await isPortListening("127.0.0.1", localPort, 800)) {
		const fresh = await findFreePort(TUNNEL_PORT_MIN, TUNNEL_PORT_MAX, localPort !== void 0 ? /* @__PURE__ */ new Set([localPort]) : void 0);
		if (fresh === void 0) {
